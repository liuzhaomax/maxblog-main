        ...
        stage("Checkout") {
            steps {
                ...
                timeout(time: 3, unit: "MINUTES"){
                    checkout([$class: "GitSCM", branches: [[name: "**"]], extensions: [], userRemoteConfigs: [[url: "https://github.com/liuzhaomax/maxblog-main.git"]]])
                }
                echo "--------------------- Checkout End ---------------------"
            }
        }
